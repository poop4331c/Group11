...
|010 |"As a player, I want to be able to exit the game from the main menu "|2|1|"When I open the main menu an exit button will be displayed and will exit the game when clicked" |WORKING|
