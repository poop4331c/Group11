...
|010 |"As a player, I want to be able to exit the game from the main menu "|2|1|"when I open the main menu an exit button will be display and will exit the game when clicked" |WORKING|
